...
from module3_incident_monitoring.anpr.train_ocr import (
...
class ANPREngine:
    ...
    def __init__(
        ...
        if checkpoint_path is None:
            # Check unified directory first, fallback to legacy
            p1 = Path("module3_incident_monitoring/anpr/ocr_checkpoints/best_ocr_model.pt")
            p2 = Path("module3_incident_anpr/ocr_checkpoints/best_ocr_model.pt")
            checkpoint_path = p1 if p1.exists() else p2
        else:
